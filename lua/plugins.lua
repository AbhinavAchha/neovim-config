...
return packer.startup(function(use)
	...
	use({ "williamboman/mason.nvim", config = require("mason_config") })
	use({ "williamboman/mason-lspconfig.nvim" })

	use({ "nvim-treesitter/nvim-treesitter", run = ":TSUpdate", config = require("treesitter_config") })
	use({ "akinsho/toggleterm.nvim", config = require("toggleterm_config"), tag = "*" })
	...
	use({ "lukas-reineke/indent-blankline.nvim", config = require("indent_blankline_config") })
	use({ "mg979/vim-visual-multi", branch = "master" })
	use({ "mhartington/formatter.nvim", config = require("formatting") })
	use({ "JoosepAlviste/nvim-ts-context-commentstring", config = require("context_commentstring") })
	...
	use({ "jinh0/eyeliner.nvim", config = require("eyeliner_config") })
	use({ "Pocco81/AbbrevMan.nvim", config = require("abbrevman_config") })
